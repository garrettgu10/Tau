...
struct qt_meta_stringdata_GGraphicsView_t {
    QByteArrayData data[1];
    char stringdata0[14];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_GGraphicsView_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_GGraphicsView_t qt_meta_stringdata_GGraphicsView = {
    {
QT_MOC_LITERAL(0, 0, 13) // "GGraphicsView"
...
const QMetaObject GGraphicsView::staticMetaObject = {
    { &QGraphicsView::staticMetaObject, qt_meta_stringdata_GGraphicsView.data,
      qt_meta_data_GGraphicsView,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *GGraphicsView::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_GGraphicsView.stringdata0))
